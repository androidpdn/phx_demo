defmodule Mix.Tasks.Tailwind.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.

      mix tailwind.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  the CLI.
      ...
      # Via CLI
      mix tailwind.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ...
  the type makes it default to `:string`:
      ...
      mix tailwind.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      mix tailwind.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      mix tailwind.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      mix tailwind.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique
  ...
  a `--table` option may be provided. For example:
      ...
      mix tailwind.gen.schema Blog.Post posts --table cms_posts
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise("mix tailwind.gen.schema can only be run inside an application directory")
    end
  ...
  def copy_new_files(%Schema{context_app: ctx_app} = schema, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/tailwind.gen.schema", binding, files)
    ...
    if schema.migration? do
      ...
      Mix.Phoenix.copy_from(paths, "priv/templates/tailwind.gen.schema", binding, [
  ...
  def raise_with_help(msg) do
    ...
    mix tailwind.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix tailwind.gen.schema Blog.Post blog_posts title:string
    """)
  end
